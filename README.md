...
- **Windows native client (WinUI 3)** – Native camera/microphone capture and rendering, adaptive rooms with up to four participants, persistent call and host preferences, named saved rooms, WebSocket/SSE signaling, TURN refresh, and reconnect recovery
